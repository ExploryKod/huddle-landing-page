...
export default function ImageText({ imageUrl, title, description, imagePosition = "left" }:
    ...
    return (
        <article className={`max-w-7xl px-5 py-10 mx-auto shadow-md rounded-2xl bg-white image-text 
        flex items-center gap-x-15 ${imagePosition === "right" ? "sm:flex-row-reverse flex-col" : "sm:flex-row flex-col"}`}>
